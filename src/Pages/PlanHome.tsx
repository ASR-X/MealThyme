  ...
  const MealCard = ({item}): React.ReactElement => {
    return (
      <TouchableOpacity onPress={() => {
        setweekplan({ ...weekplan, selectedMeal: parseInt(item.id) -1, selectedDish:1 })
    ...
    <View style={{
     ...
     <View style={{
      ...
      <Image source={{uri: 'https://asrx.ngrok.io/image?id=' + getID(item.id), height: 120}}
          style = {{
            width: 40,
            height: 40,
            borderRadius: 20
              ...
              marginVertical: 15,
                ...
                >Fruits: </Text>
                  ...
                  <TouchableOpacity style={{zIndex: 2}} onPress={() => {
                    ...
                    <Icon name="chevron-forward-circle-outline" type="ionicon" color={item.checked ? primary : white} containerStyle={{height: 50, width: 50, alignContent: 'center', justifyContent: 'center'}} />
                  </TouchableOpacity>
                </View>
                 </View>
            </View>
    ...
    <SafeAreaView
      ...
      >
          <FlatList
            ...
            contentContainerStyle={{ justifyContent: 'flex-start', paddingBottom:20, paddingTop: 35, }} 
            />
